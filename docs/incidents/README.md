...
| [0025](0025-powershell-expanded-replacement-capture.md) | 2026-07-21 | PowerShell expanded `$1` inside a Node replacement command before Node saw it, briefly erasing matched golden-fixture values. Self-verification caught and restored it before tests/commit. Use replacement callbacks or literal-safe patching for shell-sensitive captures, then verify semantic anchors. |
| [0026](0026-route-editor-e2e-omitted-from-affected-set.md) | 2026-07-21 | A Headquarters route-editor change ran Headquarters + Ledger affected e2e but omitted the dedicated qty/margin route-editor spec; full CI caught its stale implicit-delivery setup. Derive affected specs from changed behavior/selectors, not filenames or broad feature labels. |
