...
| [oq8-buildingStoreValue-grill-2026-07-21](oq8-buildingStoreValue-grill-2026-07-21.md) | HIST | Closes OQ8: a building's standing goods store gets a generic `buildingStoreValue` field so E15 reuses it without a second version bump. Its "E15 uses v15" call is struck in the note itself — v15 went to #391/#399; E15's spec now names no fixed number (#425). |
