...
- **Shares & the exchange (giełda)** — sell equity to raise investment capital; investors are shown the *investor lens* — gross margin + ROI, upkeep in small print — the startup framing where top-line and growth are priced above accounting caution. Foreshadowed by the E16/#390 two-lens profitability register (investor vs operator view of the same route). No unpark trigger — a real grill enters it. (Owner, 2026-07-22 #390 grill.)
