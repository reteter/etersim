...
| **Orchestrator** | implementation: issues → packages → waves → integration | `docs/WORKFLOW.md` §Verification gates (the tier table), §Model ladder, §Batching, §PR timing, §Session rituals, §Casting; `docs/personas/ORCHESTRATOR.md`; §Git & worktrees below; `docs/incidents/README.md` §Log; the epic spec + `docs/specs/README.md` |
