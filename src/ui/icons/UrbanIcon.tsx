...
/**
 * Urban port archetype icon (CONTEXT.md: Port archetype). Vendored ready for
 * #44 (archetype icons on the map); single-path monochrome SVG, tinted via
 * `fill: currentColor` (docs/adr/0006-svg-icon-strategy.md).
 * Source: "Modern City" by Delapouite, game-icons.net — CC BY 3.0
 * (https://creativecommons.org/licenses/by/3.0/).
 */
export function UrbanIcon(props: SVGProps<SVGSVGElement>) {
  return (
